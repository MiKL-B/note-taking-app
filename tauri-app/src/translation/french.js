export default {
    ...
    confirm_note_deleted: "Etes-vous sûr de vouloir déplacer vers la corbeille {note_name}?",
    confirm_note_deleted_permanent:"Etes-vous sûr de vouloir supprimer définitivement {note_name}?",
    confirm_close_app:
    ...
    no_duplicate_deleted:"Vous ne pouvez pas dupliquer une note de la corbeille!",
    // filternote
    sortAZ: "Tri A -> Z",
    sortZA: "Tri Z -> A",
